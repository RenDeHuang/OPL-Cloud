...
test("Current Fabric contracts require dedicated package NodePools without weakening Workspace renewal", async () => {
  ...
  assert.deepEqual(deployment.productionWorkspaceRecoveryPlan, {
    ...
    artifact: {
      ...
      computeClaimEvidenceAuthority: "Fabric_ClaimComputeRecovery_persisted_reconciliation_and_mutation_ledger_digest_only_projection",
      computeClaimEvidenceConsumer: "failed_original_Recovery_Plan_execution_readback_only",
