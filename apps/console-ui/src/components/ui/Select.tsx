...
export function Select({ label, description, error, id: suppliedId, onChange, ...props }: SelectProps) {
  ...
  return (
    <div className="console-field">
      ...
      <div aria-invalid={Boolean(error)} className="console-select" data-invalid={Boolean(error)}>
        <AppsSelect {...props} id={id} onChange={(option) => onChange(option.value)} pill={false} />
      </div>
