...
const (
	// Label holds the string label denoting the holdactivation type in the database.
	Label = "hold_activation"
	...
	FieldStatus = "status"
	// FieldProviderEvidenceRef holds the string denoting the provider_evidence_ref field in the database.
	FieldProviderEvidenceRef = "provider_evidence_ref"
	...
	// Table holds the table name of the holdactivation in the database.
	Table = "hold_activations"
)

// Columns holds all SQL columns for holdactivation fields.
var Columns = []string{
	FieldID,
	FieldAccountID,
	FieldWorkspaceID,
...
var (
	...
	// ProviderEvidenceRefValidator is a validator for the "provider_evidence_ref" field. It is called by the builders before save.
	ProviderEvidenceRefValidator func(string) error
...
// OrderOption defines the ordering options for the HoldActivation queries.
...
// ByProviderEvidenceRef orders the results by the provider_evidence_ref field.
func ByProviderEvidenceRef(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldProviderEvidenceRef, opts...).ToFunc()
}
