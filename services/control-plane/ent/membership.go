...
func (*Membership) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case membership.FieldQuantity:
			values[i] = new(sql.NullFloat64)
		case membership.FieldAmountCents, membership.FieldBalanceCents, membership.FieldFrozenCents, membership.FieldAvailableCents, membership.FieldTotalSpentCents:
			values[i] = new(sql.NullInt64)
		case membership.FieldID, membership.FieldAccountID, membership.FieldOwnerAccountID, membership.FieldOwnerUserID, membership.FieldUserID, membership.FieldEmail, membership.FieldRole, membership.FieldStatus, membership.FieldName, membership.FieldWorkspaceID, membership.FieldResourceID, membership.FieldResourceKind, membership.FieldOperationID, membership.FieldProvider, membership.FieldProviderResourceID, membership.FieldURL, membership.FieldHoldID, membership.FieldHoldReleaseID, membership.FieldLedgerEntryID, membership.FieldWalletTransactionID, membership.FieldSettlementID, membership.FieldPricingVersion, membership.FieldUnit, membership.FieldReason, membership.FieldResult, membership.FieldSource, membership.FieldDirection:
			values[i] = new(sql.NullString)
		case membership.FieldCreatedAt, membership.FieldUpdatedAt, membership.FieldArchivedAt:
...
func (m *Membership) String() string {
	...
	builder.WriteString(m.OwnerAccountID)
	builder.WriteString(", ")
	builder.WriteString("owner_user_id=")
	builder.WriteString(m.OwnerUserID)
	builder.WriteString(", ")
	...
	builder.WriteString(m.ResourceKind)
	builder.WriteString(", ")
	builder.WriteString("operation_id=")
	builder.WriteString(m.OperationID)
	builder.WriteString(", ")
	builder.WriteString("provider=")
	builder.WriteString(m.Provider)
	builder.WriteString(", ")
	builder.WriteString("provider_resource_id=")
	builder.WriteString(m.ProviderResourceID)
	builder.WriteString(", ")
	builder.WriteString("url=")
	builder.WriteString(m.URL)
	builder.WriteString(", ")
	builder.WriteString("hold_id=")
	builder.WriteString(m.HoldID)
	builder.WriteString(", ")
	builder.WriteString("hold_release_id=")
	builder.WriteString(m.HoldReleaseID)
	builder.WriteString(", ")
	builder.WriteString("ledger_entry_id=")
	builder.WriteString(m.LedgerEntryID)
	builder.WriteString(", ")
	builder.WriteString("wallet_transaction_id=")
	builder.WriteString(m.WalletTransactionID)
	builder.WriteString(", ")
	builder.WriteString("settlement_id=")
	builder.WriteString(m.SettlementID)
	builder.WriteString(", ")
	builder.WriteString("pricing_version=")
	builder.WriteString(m.PricingVersion)
	builder.WriteString(", ")
	builder.WriteString("amount_cents=")
	builder.WriteString(fmt.Sprintf("%v", m.AmountCents))
	builder.WriteString(", ")
	builder.WriteString("balance_cents=")
	builder.WriteString(fmt.Sprintf("%v", m.BalanceCents))
	builder.WriteString(", ")
	builder.WriteString("frozen_cents=")
	builder.WriteString(fmt.Sprintf("%v", m.FrozenCents))
	builder.WriteString(", ")
	builder.WriteString("available_cents=")
	builder.WriteString(fmt.Sprintf("%v", m.AvailableCents))
	builder.WriteString(", ")
	builder.WriteString("total_spent_cents=")
	builder.WriteString(fmt.Sprintf("%v", m.TotalSpentCents))
	builder.WriteString(", ")
