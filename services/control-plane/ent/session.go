...
func (*Session) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case session.FieldQuantity:
			values[i] = new(sql.NullFloat64)
		case session.FieldAmountCents, session.FieldBalanceCents, session.FieldFrozenCents, session.FieldAvailableCents, session.FieldTotalSpentCents:
			values[i] = new(sql.NullInt64)
		case session.FieldID, session.FieldAccountID, session.FieldOwnerAccountID, session.FieldOwnerUserID, session.FieldUserID, session.FieldEmail, session.FieldRole, session.FieldStatus, session.FieldName, session.FieldWorkspaceID, session.FieldResourceID, session.FieldResourceKind, session.FieldOperationID, session.FieldProvider, session.FieldProviderResourceID, session.FieldURL, session.FieldHoldID, session.FieldHoldReleaseID, session.FieldLedgerEntryID, session.FieldWalletTransactionID, session.FieldSettlementID, session.FieldPricingVersion, session.FieldUnit, session.FieldReason, session.FieldResult, session.FieldSource, session.FieldDirection:
			values[i] = new(sql.NullString)
		case session.FieldCreatedAt, session.FieldUpdatedAt, session.FieldArchivedAt:
	...
	for i := range columns {
		...
		case session.FieldAccountID:
			if value, ok := values[i].(*sql.NullString); !ok {
				...
				s.AccountID = value.String
			}
		case session.FieldOwnerAccountID:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field owner_account_id", values[i])
			} else if value.Valid {
				s.OwnerAccountID = value.String
			}
		case session.FieldOwnerUserID:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field owner_user_id", values[i])
			} else if value.Valid {
				s.OwnerUserID = value.String
			}
		...
		case session.FieldArchivedAt:
			if value, ok := values[i].(*sql.NullTime); !ok {
				...
				s.ArchivedAt = new(time.Time)
				*s.ArchivedAt = value.Time
			}
		default:
...
func (s *Session) String() string {
	...
	builder.WriteString(s.AccountID)
	builder.WriteString(", ")
	builder.WriteString("owner_account_id=")
	builder.WriteString(s.OwnerAccountID)
	builder.WriteString(", ")
	builder.WriteString("owner_user_id=")
	builder.WriteString(s.OwnerUserID)
	builder.WriteString(", ")
	...
	builder.WriteString(s.ResourceID)
	builder.WriteString(", ")
	builder.WriteString("resource_kind=")
	builder.WriteString(s.ResourceKind)
	builder.WriteString(", ")
	builder.WriteString("operation_id=")
	builder.WriteString(s.OperationID)
	builder.WriteString(", ")
	builder.WriteString("provider=")
	builder.WriteString(s.Provider)
	builder.WriteString(", ")
	builder.WriteString("provider_resource_id=")
	builder.WriteString(s.ProviderResourceID)
	builder.WriteString(", ")
	builder.WriteString("url=")
	builder.WriteString(s.URL)
	builder.WriteString(", ")
	builder.WriteString("hold_id=")
	builder.WriteString(s.HoldID)
	builder.WriteString(", ")
	builder.WriteString("hold_release_id=")
	builder.WriteString(s.HoldReleaseID)
	builder.WriteString(", ")
	builder.WriteString("ledger_entry_id=")
	builder.WriteString(s.LedgerEntryID)
	builder.WriteString(", ")
	builder.WriteString("wallet_transaction_id=")
	builder.WriteString(s.WalletTransactionID)
	builder.WriteString(", ")
	builder.WriteString("settlement_id=")
	builder.WriteString(s.SettlementID)
	builder.WriteString(", ")
	builder.WriteString("pricing_version=")
	builder.WriteString(s.PricingVersion)
	builder.WriteString(", ")
	builder.WriteString("amount_cents=")
	builder.WriteString(fmt.Sprintf("%v", s.AmountCents))
	builder.WriteString(", ")
	builder.WriteString("balance_cents=")
	builder.WriteString(fmt.Sprintf("%v", s.BalanceCents))
	builder.WriteString(", ")
	builder.WriteString("frozen_cents=")
	builder.WriteString(fmt.Sprintf("%v", s.FrozenCents))
	builder.WriteString(", ")
	builder.WriteString("available_cents=")
	builder.WriteString(fmt.Sprintf("%v", s.AvailableCents))
	builder.WriteString(", ")
	builder.WriteString("total_spent_cents=")
	builder.WriteString(fmt.Sprintf("%v", s.TotalSpentCents))
	builder.WriteString(", ")
	builder.WriteString("quantity=")
	builder.WriteString(fmt.Sprintf("%v", s.Quantity))
	builder.WriteString(", ")
	builder.WriteString("unit=")
	builder.WriteString(s.Unit)
	builder.WriteString(", ")
	builder.WriteString("reason=")
	builder.WriteString(s.Reason)
	builder.WriteString(", ")
	builder.WriteString("result=")
	builder.WriteString(s.Result)
	builder.WriteString(", ")
	builder.WriteString("source=")
	builder.WriteString(s.Source)
	builder.WriteString(", ")
	builder.WriteString("direction=")
	builder.WriteString(s.Direction)
	builder.WriteString(", ")
